...
# numbers would need to be changed based on above results of which is in which group
test.1 <- filter(invade.runs, run == 1, inv == 's.p')
test.3 <- filter(invade.runs, run == 3, inv == 's.p')
test.11 <- filter(invade.runs, run == 11, inv == 's.p')
