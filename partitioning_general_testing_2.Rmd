...
Same as above but doing multiple runs for troubleshooting
...
which(abs(sp.res.gr$gr.an.mean) > 0.003)
hist(sp.res.gr$gr.an.mean)
hist(sp.res.gr$gr.an.log.mean)
...
test.4 <- filter(invade.runs, run == 4, inv == 's.p')
test.5 <- filter(invade.runs, run == 5, inv == 's.p')
test.6 <- filter(invade.runs, run == 6, inv == 's.p')
test.7 <- filter(invade.runs, run == 7, inv == 's.p')
plot_gr(test.1)
...
hist(log(test.1$gr.an), ylim = c(0, 250))
hist(log(test.2$gr.an), ylim = c(0, 250))
hist(log(test.3$gr.an), ylim = c(0, 250))
hist(log(test.4$gr.an), ylim = c(0, 250))
hist(log(test.5$gr.an), ylim = c(0, 250))
hist(log(test.6$gr.an), ylim = c(0, 250))
hist(log(test.7$gr.an), ylim = c(0, 250))
