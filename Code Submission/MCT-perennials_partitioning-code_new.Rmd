...
# want a more consistent/varying way for setting these starting values (high, equal, and low)
N0.1 <- 1/length(sp.1)
N0.2 <- 1/length(sp.2) 
...
for(t in 1:time.full){
  # parameters for the varying env condition
    ...
    # saving this output as the invader population and the impacted resident population
    n.all[t+1,sp.1] <- n.res.impact[sp.1]
    n.all[t+1,sp.2] <- n.res.impact[sp.2]
}
