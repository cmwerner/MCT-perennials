...
```
Testing the non-varying runs (relies on code in section above). *TO DO: double-check growth rate calculations in both run_full and run_varying to see why they're not working for the first time step* 
```{r variable-run}
