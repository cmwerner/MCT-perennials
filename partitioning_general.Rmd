...
plot_gr(test.3)
ggsave(filename = 'test3_gr.pdf')
plot_gr(test.4)
ggsave(filename = 'test4_gr.pdf')

plot_invasion(test.3)
ggsave(filename = 'test3_pop.pdf')
plot_invasion(test.4)
ggsave(filename = 'test4_pop.pdf')

hist(test.3$gr.s.p)
hist(test.4$gr.s.p)

mean(log(test.3$gr.s.p))
mean(log(test.4$gr.s.p))
