...
env.ratio <- 0.3 # ratio of wet years to dry years
...
Running over an environmental sequence instead of a particular env.ratio
*note that the partition call is not yet generalized*
```{r env-seq}
# This determines which coexistence pair we're looking at
pair <- 'as.an'
#pair <- 'p.an'
